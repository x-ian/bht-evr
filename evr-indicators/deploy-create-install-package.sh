...
cp evr-bootcount.sh evr-indicators.sh get-serial.sh install.sh maintenance.sh update-scripts-from-server.sh ./evr-indicators-package
cp -R ssh-keys-from-evr-server ./evr-indicators-package
